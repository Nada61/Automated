<header class="main-header">
  ...
  <a href="/" class="logo" style="background-color: #fff;">
    ...
    <b class="logo-mini">
      <span class="light-logo"><img src="{{asset('images/small-logo.png')}}" alt="logo"></span>
      <span class="dark-logo"><img src="{{asset('images/small-logo.png')}}" alt="logo"></span>
    </b>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg" style="background-color: #fff;">
      <img src="{{asset('images/small-logo.png')}}" alt="logo" class="light-logo">
      <img src="{{asset('images/small-logo.png')}}" alt="logo" class="dark-logo">
    </span>
  </a>
